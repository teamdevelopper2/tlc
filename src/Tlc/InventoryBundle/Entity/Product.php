...
class Product
{
   ...
   /**
    *
    * @ORM\OneToMany(targetEntity="Tlc\InventoryBundle\Entity\OrderPurchaseProduct", mappedBy="product")
    */
    ...
    * @return Product
    */
   public function addOrderSaleProduct(OrderSaleProduct $orderSaleProduct)
   {
    ...
    * @param \Tlc\InventoryBundle\Entity\OrderSaleProduct $orderSaleProduct
    */
   public function removeOrderSaleProduct(OrderSaleProduct $orderSaleProduct)
   {
    ...
    * @return Product
    */
   public function addOrderpurchaseProduct(OrderPurchaseProduct $orderpurchaseProduct)
   {
